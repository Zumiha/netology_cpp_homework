...
ALeaveMeAloneCharacter::ALeaveMeAloneCharacter()
{
	...
	CameraBoom->TargetArmLength = 1400.0f; // The camera follows at this distance behind the character	
...
void ALeaveMeAloneCharacter::NotifyControllerChanged()
{
...
void ALeaveMeAloneCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
