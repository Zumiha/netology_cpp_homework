...
{    ///Тут должен быть код ДЗ
    ...
    if (ui->cb_category->currentText() == "Все") {
        request_title_descript = "SELECT title, description, c.name FROM film f JOIN film_category fc on f.film_id = fc.film_id JOIN category c on c.category_id  = fc.category_id";
    } else if (ui->cb_category->currentText() == "Ужасы") {
        request_title_descript = "SELECT title, description, c.name FROM film f JOIN film_category fc on f.film_id = fc.film_id JOIN category c on c.category_id = fc.category_id WHERE c.name = 'Horror'";
    } else if (ui->cb_category->currentText() == "Комедия") {
        request_title_descript = "SELECT title, description, c.name FROM film f JOIN film_category fc on f.film_id = fc.film_id JOIN category c on c.category_id = fc.category_id WHERE c.name = 'Comedy'";
    } else {
